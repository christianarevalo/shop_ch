...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { is_active: @variant.is_active, price: @variant.price, quantity: @variant.quantity }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { is_active: @variant.is_active, price: @variant.price, quantity: @variant.quantity }
    assert_redirected_to variant_path(assigns(:variant))
  end
